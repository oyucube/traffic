...
class BASE(chainer.Chain):
    def __init__(self, n_units=256, n_out=0, img_size=112, var=0.18, n_step=2, gpu_id=-1):
        super(BASE, self).__init__(
            ...
            norm_1=L.BatchNormalization(8),
            norm_2=L.BatchNormalization(32),
            norm_3=L.BatchNormalization(64),
            norm_f=L.BatchNormalization(n_units),
            ...
            norm_c1=L.BatchNormalization(4),
            norm_c2=L.BatchNormalization(4),
            norm_c3=L.BatchNormalization(4),
    ...
    def first_forward(self, x, num_lm):
        ...
        h2 = F.relu(self.norm_c1(self.context_cnn_1(F.max_pooling_2d(x, 2, stride=2))))
        h3 = F.relu(self.norm_c2(self.context_cnn_2(F.max_pooling_2d(h2, 2, stride=2))))
        h4 = F.relu(self.norm_c3(self.context_cnn_3(F.max_pooling_2d(h3, 2, stride=2))))
    ...
    def recurrent_forward(self, xm, lm):
        ...
        hg1 = F.relu(self.norm_1(self.glimpse_cnn_1(Variable(xm))))
        hg2 = F.relu(self.norm_2(self.glimpse_cnn_2(hg1)))
        hg3 = F.relu(self.norm_3(self.glimpse_cnn_3(F.max_pooling_2d(hg2, 2, stride=2))))
        hgf = F.relu(self.norm_f(self.glimpse_full(hg3)))
